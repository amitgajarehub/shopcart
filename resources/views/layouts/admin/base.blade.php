					...
					<div class="primary-nav-section">
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
								...
								<li class="menu-item">
									<a href="{{ route('admin.categories') }}" class="link-term mercado-item-title">Category</a>
								</li>
								<li class="menu-item">
									<a href="/product" class="link-term mercado-item-title">Product</a>
								</li>
								<li class="menu-item">
									<a href="/banner" class="link-term mercado-item-title">Banner</a>
								</li>
								<li class="menu-item">
			...
			<div class="coppy-right-box">
				<div class="container">
					...
					<div class="coppy-right-item item-right">
						<p class="coppy-right-text">Surf Side Version : V 1.01</p>
					</div>
